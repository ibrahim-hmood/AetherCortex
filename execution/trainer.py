...
class BrainTrainer:
    ...
    @tf.function
    def train_predictive_step(self, visual_train_t, auditory_train_t, target_text_rates_t_plus_1, bio_train_mode=False):
        """
        ...
        if bio_train_mode:
            ...
            predicted_text_rates = tf.reduce_mean(brocas_spikes, axis=1)
            predicted_visual_rates = tf.reduce_mean(visual_spikes, axis=1)
            ...
            # Autonomic biological updates on the fly without derivatives
