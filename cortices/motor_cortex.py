...
class VisualMotorCortex(SubCortexNetwork):
    ...
    """
    def __init__(self, executive_dim=256, decode_shape=(64, 64, 3), threshold=1.0, noise_std=0.01, init_stddev=0.1):
        super().__init__(name="Visual Motor Decoder Lobe")
        
        # D1: Abstract Thought Expansion
        self.add_layer(LIFCortexLayer(executive_dim, 1024, threshold=threshold, noise_std=noise_std, init_stddev=init_stddev))
